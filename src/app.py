...
activities = {
    ...
    "Basketball Club": {
        "description": "Team practices, scrimmages, and weekend games",
        "schedule": "Mondays and Wednesdays, 4:00 PM - 6:00 PM",
        "max_participants": 15,
        "participants": ["liam@mergington.edu", "noah@mergington.edu"]
    },
    "Soccer Team": {
        "description": "Outdoor practices, drills, and interschool matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 6:00 PM; Saturdays for matches",
        "max_participants": 18,
    ...
    "Science Club": {
        "description": "Experiments, guest lectures, and science fair projects",
